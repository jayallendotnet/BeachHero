    ...
    public class SkinDataPropertyDrawer : PropertyDrawer, System.IDisposable
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (data.PreviewProperty != null)
            {
                ...
                {
                   GUI.DrawTexture(new Rect(boxRect.x + 2, boxRect.y + 2, 55, 55),new Texture2D(1,1));
                }
            }
        ...
        private class PropertyData
        {
            ...
            public readonly BindingFlags FLAGS_INSTANCE = BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public;
            ...
            public PropertyData(SerializedProperty property)
            {
                ...
                IEnumerable<FieldInfo> fieldInfos = targetType.GetFields(FLAGS_INSTANCE);
