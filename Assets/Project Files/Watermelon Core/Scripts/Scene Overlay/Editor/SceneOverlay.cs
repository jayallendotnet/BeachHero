...
namespace Bokka
{
    ...
    public class SceneOverlay : UnityEditor.Overlays.Overlay
    {
        ...
        private void BuildUI()
        {
            ...
            if (useShowNawMesh && ( showNawmeshToggle != null))
            {
            ...
            if(gizmoFoldoutStyleCancel.childCount > 0)
            {
            ...
            if(pickabilityStyleCancel.childCount > 0)
            {
            ...
            if(visibilityStyleCancel.childCount > 0)
            {
            ...
            if (!EditorApplication.isPlayingOrWillChangePlaymode)
            {
                ...
                if(interfacesFoldoutStyleCancel.childCount > 0)
                {
            ...
            {
                root.Add(new Label("Database is empty."));
            }
        ...
        {
            if(!gameObjectsPickabilityToggles.IsNullOrEmpty())
            {
                for (int i = 0; i < gameObjectsPickabilityToggles.Count; i++)
                {
        ...
        {
            if (!gameObjectsVisibilityToggles.IsNullOrEmpty())
            {
                for (int i = 0; i < gameObjectsVisibilityToggles.Count; i++)
                {
        ...
        private void CacheGroups()
        {
            ...
            useShowNawMesh = serializedObject.FindProperty("useShowNawMesh").boolValue;
        ...
        {
            if(gameObjectPickabilityGroups != null)
            {
            ...
            if(gameObjectVisibilityGroups != null)
            {
